        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <section className="lg:w-1/3 lg:pr-8 mb-8">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Alumni Connect is a platform that bridges the gap between graduates and their alma mater, fostering networking, mentorship, and collaboration. It enables alumni and students to stay connected, share opportunities, and build a supportive community.
            </p>
